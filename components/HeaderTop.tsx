...
import { FaArrowRightToBracket, FaHeadphones, FaRegEnvelope, FaRegUser } from "react-icons/fa6";
...
>
  <FaArrowRightToBracket className="mr-2" /> {/* Add margin to the right of the icon for spacing */}
  Log out
</button>
